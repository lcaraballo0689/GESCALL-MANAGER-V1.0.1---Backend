...
// Fixed AGI: Uses phone_number (from extension) to find campaign
const agiContent = `#!/usr/bin/perl
#
# callerid_local_presence.agi - GesCall CallerID Rotation
# Fixed: Uses phone_number for campaign lookup
#
...
if (!$phone_number) {
    agi_log("No phone number - exiting");
    exit(0);
}
...
# Find campaign using phone_number (not uniqueid since it's often NULL)
my $campaign_id = '';
...
echo "AGI Updated - Now uses phone_number for lookup"
`;

console.log('Fixing AGI Campaign Lookup...\n');
