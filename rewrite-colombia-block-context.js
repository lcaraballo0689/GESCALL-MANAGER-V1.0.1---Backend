...
const command = `
# Backup
cp /etc/asterisk/extensions-vicidial.conf /etc/asterisk/extensions-vicidial.conf.bak.final2

# Delete existing 57 lines (cleanup previous attempt)
sed -i '/exten => _57XXXXXXXX./d' /etc/asterisk/extensions-vicidial.conf
# Also delete any stray [default] I might have added? Logic below handles append.
...
tail -n 20 /etc/asterisk/extensions-vicidial.conf

echo "--- Reloading ---"
asterisk -rx "dialplan reload"
`;

console.log('Rewriting Colombia Dialplan Block (With Context)...\n');
